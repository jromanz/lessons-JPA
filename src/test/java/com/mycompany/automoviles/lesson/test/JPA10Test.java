...
public class JPA10Test {
	...
	public static void main(String[] args) {
		...
		// orphanRemoval = true se elimina los registros de la tabla hija asociada
		...
		Estilo estilo1 = new Estilo("Estilo 1");
		Estilo estilo2 = new Estilo("Estilo 2");
		...
		try {
			...
			//	Ejecuta pero no funciona, tiene entidades asociadas
			menuPersist.setSubItem2(null);	
			em.getTransaction().commit();
		} catch (Exception e) {
			if (em.isOpen()) {
